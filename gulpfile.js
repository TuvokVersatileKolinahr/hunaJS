...
gulp.task('scripts-vendor', ['scripts-vendor-maps'], function() {
  ...
  return gulp.src([options.src + 'js/vendor/*/**/angular.min.js',options.src + 'js/vendor/**/*.js'])
...
gulp.task('styles', function() {
  ...
  return gulp.src([options.src + 'styles/main.scss', options.src + '/js/vendor/**/c3.min.css'])
    .pipe(plumber(options.plumberConfig()))
